...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-2xl p-5">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
                <p class="text-[11px] text-zinc-500 uppercase tracking-wider">Selling Domain</p>
                <p class="text-sm font-mono text-violet-400 mt-1">{{ $email->owned_domain }}</p>
            </div>
            <div>
        ...
        <div class="mt-4 pt-4 border-t border-zinc-800/50">
            <p class="text-[11px] text-zinc-500 uppercase tracking-wider">Prospect Website</p>
            <p class="text-sm font-mono text-white mt-1">{{ $email->target_website }}</p>
        </div>
        @endif
    </div>
